...
def eror_resonse(message, status=400):
...
def get_exercise(exercise_id):
    """Return a single exercise with its associated work outs."""
...
# Schema validation
    ...
    # Cross-field schema validation: reps or duration_seconds required
